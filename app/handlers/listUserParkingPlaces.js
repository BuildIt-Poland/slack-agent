...
const { getParkingPlacesForBookings } = require('../services/parkingPlacesService.js');
...
module.exports.my = async event => {
  ...
  const myParkingPlaces = getParkingPlacesForBookings(futureBookings, message.userName);
